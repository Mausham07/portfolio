  ...
  return (
    <div className="a">
      ...
      <div className="a-right">
        ...
        <p className="a-desc">
        I am a passionate computer science student and a perpetual learner. 
        ...
        computer science community. Together, let's push the boundaries of what can 
        be achieved and shape the future through the power of technology.
        </p>
        </div>
    </div>
  );
